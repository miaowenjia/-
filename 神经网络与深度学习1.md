...
![9](D:\研1\课程资料\神经网络与深度学习\课堂笔记\figure\9.png)
...
$$
小批量样本特征:\mathbf{X}\in \mathbb{R^{n\times d}},权重为:\mathbf{W}\in \mathbb{R^{d\times q}},
...
\frac{\partial l(\mathbf{y},\mathbf{\hat{y}})}{\partial \mathbf{O}}=
