...
$$
令\delta_i^{[l]}=(\sum_{j=1}^m w_{ji}^{[l+1]}\delta_{j}^{[l+1]})(h_i^{[l]})^\prime ,则\Delta w_{ij}^{[l]} = \alpha \delta_i^{[l]}h_j^{[l-1]}
$$
...
$$
\delta_i^{[l]}=(\sum_{j=1}^m w_{ji}^{[l+1]}\delta_{j}^{[l+1]})(h_i^{[l]})^\prime
$$
